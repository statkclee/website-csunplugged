...
layout: page
title: 쵸코릿 공장 
subtitle: 휴먼 인터페이스 디자인 (Human interface design)
---
...
> | 한글 동영상 | 영어 동영상 |
> :---------------------------------: | :-------------:|
> | 애타게 찾고 있습니다. | <iframe width="350" height="260" src="https://www.youtube.com/embed/4iHPgk2u9_s" frameborder="0" allowfullscreen> </iframe> |
...
> 
> <img src="img/ch20-hci/20-hci-02-stove.png" alt="stove" width="70%"/>   
> 
...
> 
> <img src="img/ch20-hci/20-hci-03-cupboard.png" alt="cupborad" width="70%" />   
> 
...
> #### 워크시트 활동: 문을 어떻게 열지?  {.callout}
> 
> 워크쉬트를 채워서 여러분이 생각하기에 각 유형의 문을 어떻게 여는지 보여준다.  
> 
> <img src="img/ch20-hci/20-hci-04-open-doors.png" alt="open doors" width="70%" />   


> #### 워크시트 활동: 스토브(레인지) 윗면  {.callout}
> 
> 스토브(레인지)를 다시 디자인해서 제어를 쉽게하도록 만든다. 원하는 경우, 디자인에 앞면 혹은 뒷면 패널을 추가할 수 있다.  
> 
> <img src="img/ch20-hci/20-hci-05-stove.png" alt="stove" width="70%" />   


> #### 워크시트 활동: 아이콘 (Icons)   {.callout}
> 
> 여러분이 생각하기에 각 아이콘(상징)이 무엇을 의미하나요?  
> 
> <img src="img/ch20-hci/20-hci-06-icons.png" alt="icons" width="70%" />   


> #### 워크시트 활동: 아이콘 카드 (Icons cards) {.callout}
> 
> 카드를 잘라서 각 그룹에게 하나씩 나눠준다. 각 그룹이 아이콘(상징)을 디자인하는데 각 명령을 표현하는 제어부에 붙일 것이다.  
> 
> <img src="img/ch20-hci/20-hci-07-icon-cards.png" alt="icons" width="70%" />   
> 
> 
> ###### 변형과 확장  
> 
